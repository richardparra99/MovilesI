...
import com.example.juegotetris.models.Direction
import com.example.juegotetris.models.Square

class AnimationBoard(context: Context?, attrs: AttributeSet?) : View(context, attrs), Observer{
    private var square = Square(100f, 100f).apply {
        addObserver(this@AnimationBoard)
    }

    private val speed = 50L
